/****************************************************************************
 * boards/arm/ra8/fpb-ra8e1/src/ra8e1_pwm.c
 *
...
int ra8e1_escs_main(int argc, char *argv[])
{
  int ret;
  int i;
  int cmd_len = 0;
