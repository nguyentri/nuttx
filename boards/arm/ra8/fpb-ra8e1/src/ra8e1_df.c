/****************************************************************************
 * boards/arm/ra8/fpb-ra8e1/src/ra8e1_data_flash.c
 *
...
#endif /* CONFIG_RA8E1_DATA_FLASH_EXAMPLE */
