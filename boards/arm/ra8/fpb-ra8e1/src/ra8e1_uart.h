...
int ra8e1_uart_init(struct uart_dev_s *dev, 
                         const struct uart_config_s *config);

/****************************************************************************
 * Name: ra8e1_uart_send_dma
 *
 * Description:
 *   Send data using DMA
 *
...
int ra8e1_uart_send_dma(struct uart_dev_s *dev, 
                              const uint8_t *buffer, 
                              uint16_t length);

/****************************************************************************
 * Name: ra8e1_uart_receive_dma
 *
 * Description:
...
int ra8e1_uart_receive_dma(struct uart_dev_s *dev, 
                                 uint8_t *buffer, 
                                 uint16_t length);

/****************************************************************************
 * Name: ra8e1_uart_get_state
 *
 * Description:
...
uart_state_t ra8e1_uart_get_state(const struct uart_dev_s *dev);

/****************************************************************************
 * Name: ra8e1_uart_set_callback
 *
 * Description:
...
void ra8e1_uart_set_callback(struct uart_dev_s *dev,
